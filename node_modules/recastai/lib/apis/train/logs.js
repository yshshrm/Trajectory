      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", _this.client.get("/users/" + _this.client.userSlug + "/bots/" + _this.client.botSlug + "/logs", params, opts));
      ...
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", _this.client.get("/users/" + _this.client.userSlug + "/bots/" + _this.client.botSlug + "/logs/" + id, params, opts));
      ...
      return _regenerator2.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", _this.client.del("/users/" + _this.client.userSlug + "/bots/" + _this.client.botSlug + "/logs/" + id, params, opts));
      ...
      return _regenerator2.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              return _context4.abrupt("return", _this.client.post("/users/" + _this.client.userSlug + "/bots/" + _this.client.botSlug + "/logs/bulk_destroy", data, opts));
      ...
      return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              return _context5.abrupt("return", _this.client.put("/users/" + _this.client.userSlug + "/bots/" + _this.client.botSlug + "/logs/bulk_archive", data, opts));
